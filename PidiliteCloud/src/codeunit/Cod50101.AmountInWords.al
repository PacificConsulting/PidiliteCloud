codeunit 50101 "Amount In Words"
{
    ...
    var
        ...
        NoTextIndex: Integer;
        TensDec: Integer; //PCPL/NSW/160322
        //TensDec: Decimal; //PCPL/NSW/160322
        OnesDec: Integer; //PCPL/NSW/160322
        //OnesDec: Decimal; //PCPL/NSW/160322
        Ones: Integer; //PCPL/NSW/160322
        //Ones: Decimal; //PCPL/NSW/160322
        Tens: Integer; //PCPL/NSW/160322
        //Tens: Decimal;//PCPL/NSW/160322
        Hundreds: Integer;
        Exponent: Integer;
    begin
        Clear(NoText);
