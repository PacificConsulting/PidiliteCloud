report 50102 "Performa Invoice"
{
    Caption = 'Performa Invoice';
    DefaultLayout = RDLC;
    RDLCLayout = 'src/reportlayout/Performa Invoice.rdl';
    ...
    dataset
    {
        dataitem(SalesHeader; "Sales Header")
        {
            ...
            column(DocDate_SalesInvoiceHeader; Format(SalesHeader."Document Date", 0, '<Day,2>/<Month,2>/<Year4>'))
            {
            }
            ...
            { }
            column(WorkOrderNo; SalesHeader."External Document No.")
            { }
            ...
            begin
                ...
                GetStatisticsAmount(SalesHeader, TCSAmount, TCSPercent);
                GetSalesStatisticsAmount(SalesHeader, TotalGSTAmount, TotalGSTPercent);
                ...
                AmtInWords.FormatNoText(NoText, Abs(GrandTotal), SalesHeader."Currency Code");
    ...
    local procedure FormatAddressFields(var Header: Record "Sales Header")
    begin
